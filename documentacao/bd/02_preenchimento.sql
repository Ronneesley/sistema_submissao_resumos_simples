...
INSERT INTO `organizadores` (`id`, `nome`, `login`, `senha`, `data_cadastro`, `email`) VALUES ('1', 'thallison', 'teste', '123', '2024-08-08', 'thallison@gmail.com');
INSERT INTO `organizadores` (`id`, `nome`, `login`, `senha`, `data_cadastro`, `email`) VALUES ('2', 'otavio', 'teste', '12332', '2024-09-08', 'otavio@gmail.com');
INSERT INTO `organizadores` (`id`, `nome`, `login`, `senha`, `data_cadastro`, `email`) VALUES ('3', 'Carlos', 'teste', '12355', '2023-05-10', 'carlosn@gmail.com');
INSERT INTO `organizadores` (`id`, `nome`, `login`, `senha`, `data_cadastro`, `email`) VALUES ('4', 'Jeova', 'teste', '1239798', '2022-01-09', 'jeova@gmail.com');
INSERT INTO `organizadores` (`id`, `nome`, `login`, `senha`, `data_cadastro`, `email`) VALUES ('5', 'Jailson', 'teste', '123345', '2021-04-06', 'jailson@gmail.com');

-- Cadastrado Autores
INSERT INTO `autores` (`id`, `nome`, `email`, `cpf`, `instituicao_ensino`, `senha`, `curso`) VALUES ('1', 'thallison', 'thallison@gmail.com', '11111111111', 'Campus Colinas', '123', '1');
INSERT INTO `autores` (`id`, `nome`, `email`, `cpf`, `instituicao_ensino`, `senha`, `curso`) VALUES ('2', 'otavio', 'otavio@gmail.com', '22222222222', 'Campus Colinas', '123345', '2');
INSERT INTO `autores` (`id`, `nome`, `email`, `cpf`, `instituicao_ensino`, `senha`, `curso`) VALUES ('3', 'carlos', 'carlosn@gmail.com', '33333333333', 'Campus Colinas', '123567', '3');
INSERT INTO `autores` (`id`, `nome`, `email`, `cpf`, `instituicao_ensino`, `senha`, `curso`) VALUES ('4', 'jeova', 'jeova@gmail.com', '44444444444', 'Campus Colinas', '123568', '4');
INSERT INTO `autores` (`id`, `nome`, `email`, `cpf`, `instituicao_ensino`, `senha`, `curso`) VALUES ('5', 'Jailson', 'jailson@gmail.com', '55555555555', 'Campus Colinas', '1232865', '5');


-- Cadastrado Avaliadores
INSERT INTO `avaliadores` (`id`, `nome`, `email`, `senha`, `curso`, `formacao`) VALUES ('1', 'carol', 'carol@gmail.com', '123', '1', 'Graduada');
INSERT INTO `avaliadores` (`id`, `nome`, `email`, `senha`, `curso`, `formacao`) VALUES ('2', 'thaisa', 'thaisa@gmail.com', '1234', '2', 'Superior');
INSERT INTO `avaliadores` (`id`, `nome`, `email`, `senha`, `curso`, `formacao`) VALUES ('3', 'monalisa', 'monalisa@gmail.com', '12345', '3', 'Tecnico');
INSERT INTO `avaliadores` (`id`, `nome`, `email`, `senha`, `curso`, `formacao`) VALUES ('4', 'beatriz', 'beatriz@gmail.com', '123456', '4', 'Mestrado');
INSERT INTO `avaliadores` (`id`, `nome`, `email`, `senha`, `curso`, `formacao`) VALUES ('5', 'ronneesley', 'ronneesley@gmail.com', '1234567', '5', 'Doutorado');
