...
VALUES 
('1', 'banner1.jpg', 'Uma conferência sobre as últimas tendências em tecnologia.', '2024-09-15', '2024-09-17', '2024-08-01', '2024-08-31', '(11) 99999-9999',now(), 'Campus Colinas', 'video1.mp4', '09:00', '17:00', '2024-09-10');
INSERT INTO eventos (`nome`, `banner`, `descricao`, `data_inicio`, `data_fim`, `periodo_inscricao_inicio`, `periodo_inscricao_fim`, `telefone`,`criado_em`, `local`, `video`, `horario_inicio`, `horario_fim`, `fim_correcao_trabalho`)
VALUES
...
-- Cadastrado Resumos
INSERT INTO resumos (`id`, `titulo`, `palavras_chave`, `texto`, `eixo_tematico`, `evento`) VALUES (1, 'A sociedade e a Democracia ', 'sociedade, democracia, desigualdade, inclusão', 'As questões sociais envolvem o estudo e a análise das diversas problemáticas que afetam a sociedade, incluindo desigualdade, pobreza, discriminação e exclusão social. Esse eixo temático busca entender as dinâmicas sociais e propor soluções para promover a justiça social e a inclusão de todas as camadas da população. Pesquisas e projetos nessa área frequentemente abordam temas como educação, moradia, segurança, trabalho e políticas públicas.', '1','1');
INSERT INTO resumos (`id`, `titulo`, `palavras_chave`, `texto`, `eixo_tematico`, `evento`) VALUES (2, 'Meio Ambiente', 'desmatamento, mudanças climáticas', 'O eixo temático de Meio Ambiente concentra-se na compreensão e preservação dos recursos naturais e ecossistemas do planeta. Envolve o estudo de problemas ambientais como poluição, desmatamento, mudanças climáticas e conservação da biodiversidade. Através desse eixo, busca-se promover a sustentabilidade, incentivar práticas ecológicas e desenvolver políticas que minimizem os impactos ambientais, assegurando um futuro equilibrado e saudável para as próximas gerações.', '2', '5');
INSERT INTO resumos (`id`, `titulo`, `palavras_chave`, `texto`, `eixo_tematico`, `evento`) VALUES (3, 'Direitos e cidadania', 'justiça, legislações, políticas ', 'Direitos e cidadania são fundamentais para garantir a dignidade, a liberdade e a igualdade entre os indivíduos. Esse eixo temático explora a proteção dos direitos humanos, a promoção da justiça, a democracia e a participação cidadã. Envolve o estudo de legislações, políticas públicas e movimentos sociais que buscam assegurar que todos os cidadãos tenham seus direitos respeitados e possam exercer plenamente suas responsabilidades e deveres na sociedade.', '3', '3');
INSERT INTO resumos (`id`, `titulo`, `palavras_chave`, `texto`, `eixo_tematico`, `evento`) VALUES (4, 'Saúde', 'prevenção, diagnóstico, tratamento', 'O eixo temático de Saúde aborda a promoção do bem-estar físico, mental e social das pessoas. Inclui o estudo de doenças, tratamentos, políticas de saúde pública e os determinantes sociais da saúde. Esse campo é essencial para desenvolver estratégias eficazes de prevenção, diagnóstico e tratamento de doenças, além de promover hábitos saudáveis e melhorar a qualidade de vida da população.', '4', '4');
INSERT INTO resumos (`id`, `titulo`, `palavras_chave`, `texto`, `eixo_tematico`, `evento`) VALUES (5, 'Arte e Cultura', 'música, teatro, literatura, dança', 'O eixo temático de Arte e Cultura investiga as diversas manifestações artísticas e culturais que compõem o patrimônio e a identidade de uma sociedade. Inclui a análise de expressões artísticas como música, teatro, literatura, dança e artes visuais, além de tradições culturais, festividades e costumes. Este campo destaca a importância da preservação e valorização cultural, promovendo o acesso à cultura e incentivando a criatividade e a inovação artística.', '5', '2');
