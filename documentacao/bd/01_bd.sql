...
CREATE TABLE IF NOT EXISTS `evento`.`eventos` (
  ...
  `resumos_id` INT NOT NULL,
  PRIMARY KEY (`id`, `resumos_id`),
  INDEX `fk_eventos_resumos1_idx` (`resumos_id` ASC) ,
  CONSTRAINT `fk_eventos_resumos1`
    FOREIGN KEY (`resumos_id`)
    REFERENCES `evento`.`resumos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
